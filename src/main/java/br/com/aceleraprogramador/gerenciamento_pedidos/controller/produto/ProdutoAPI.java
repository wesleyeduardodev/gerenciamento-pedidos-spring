...
public interface ProdutoAPI {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Produto criado com sucesso.",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = Lo.class))),
    ...
    Lo criarProduto(ProdutoRequest request);
    ...
    PageResponse<Lo> buscarTodosOsProdutosPorParametros(@Parameter(description = "Id do Produto") Long id,
    ...
    @ApiResponse(responseCode = "200", description = "Produto Retornado com sucesso.",
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = Lo.class)))
    Lo buscarProdutoPorId(@Parameter(description = "Id do Produto", required = true) Long id);
